package com.aa1.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "sunnyloves2surf@gmail.com";
	public static String password = "sunnybonnybaby";
	public static String[] to ={"swadesh112@gmail.com"};
